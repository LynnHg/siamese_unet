...
class Siamese_UNet(nn.Module):
    def __init__(self, img_ch=1, num_classes=6, aux_classes=3, depth=3):
        ...
        self.p1_dec4 = DecoderBlock(chs[4] * 3 + chs[4] * 3, chs[3])
        self.p1_decconv4 = EncoderBlock(chs[3] * 4 + chs[3] * 3, chs[3])
        self.p1_dec3 = DecoderBlock(chs[3], chs[2])
        self.p1_decconv3 = EncoderBlock(chs[2] * 4 + chs[2] * 3, chs[2])

        self.p1_dec2 = DecoderBlock(chs[2], chs[1])
        self.p1_decconv2 = EncoderBlock(chs[1] * 4 + chs[1] * 3, chs[1])

        self.p1_dec1 = DecoderBlock(chs[1], chs[0])
        self.p1_decconv1 = EncoderBlock(chs[0] * 4 + chs[0] * 3, chs[0])
        ...
        self.p2_dec4 = DecoderBlock(chs[4] * 3, chs[3])
        self.p2_decconv4 = EncoderBlock(chs[3] * 4, chs[3])
        self.p2_dec3 = DecoderBlock(chs[3], chs[2])
        self.p2_decconv3 = EncoderBlock(chs[2] * 4, chs[2])

        self.p2_dec2 = DecoderBlock(chs[2], chs[1])
        self.p2_decconv2 = EncoderBlock(chs[1] * 4, chs[1])

        self.p2_dec1 = DecoderBlock(chs[1], chs[0])
        self.p2_decconv1 = EncoderBlock(chs[0] * 4, chs[0])
